...
public class MainOrigActivity extends AppCompatActivity  implements InfoFragment.OnFragmentInteractionListener,
        HomeFragment.OnFragmentInteractionListener, TestingFragment.OnFragmentInteractionListener,
        SettingFragment.OnFragmentInteractionListener, DevicesListFragment.OnFragmentInteractionListener{
...
//                    Log.d(TAG, " navigation_set inactiveTimes " +inactiveTimes.toString());
                    ...
                    setFragment = SettingFragment.newInstance(BRUSH_NAME_TEMP, " ");
...
//                item.setShiftingMode(false);
    ...
    public void setUpToolBarOLDVers(Toolbar mToolbar, int resID, String mTitle) {
//    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
...
//        mToolbar.setLayoutParams(new Toolbar.LayoutParams(Toolbar.TEXT_ALIGNMENT_CENTER));
        ...
        mToolbar.setTextAlignment(Toolbar.TEXT_ALIGNMENT_CENTER);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(MainOrigActivity.this,
                                    ((Nameable) drawerItem).getName().getText(MainOrigActivity.this)
