...
public class JunkFragment extends Fragment {
     ...
     * @return A new instance of fragment JunkFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static JunkFragment newInstance(String param1, String param2) {
        JunkFragment fragment = new JunkFragment();
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onJunkFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onJunkFragmentInteraction(Uri uri);
    }
}
